...
var arrayify = __nccwpck_require__(912);
var dotPropGet = __nccwpck_require__(42).get;
...
const { breakingHeaderPattern } = __nccwpck_require__(622)()
...
const parserOpts = __nccwpck_require__(622)
const writerOpts = __nccwpck_require__(983)
...
const addBangNotes = __nccwpck_require__(661)
const parserOpts = __nccwpck_require__(622)
...
const conventionalChangelog = __nccwpck_require__(914)
const parserOpts = __nccwpck_require__(622)
const recommendedBumpOpts = __nccwpck_require__(539)
const writerOpts = __nccwpck_require__(983)
...
const addBangNotes = __nccwpck_require__(661)
const compareFunc = __nccwpck_require__(623)
const Q = __nccwpck_require__(172)
const readFile = Q.denodeify(__nccwpck_require__(747).readFile)
const resolve = __nccwpck_require__(277).resolve
...
module.exports = function (config) {
  ...
  return Q.all([
    ...
    readFile(__nccwpck_require__.ab + "footer2.hbs", 'utf-8')
  ])
